...
For a high-level introduction and installation instructions, see the [Swarms Docs Home](https://docs.swarms.world/).
...
1. **Agent Class (`swarms/agents`)**
    ...
    - [Quickstart for Agents](https://docs.swarms.world/swarms/agents/)
    
    - [Agent API Reference](https://docs.swarms.world/swarms/structs/agent/)
...
2. **Tools with Memory (`swarms/tools`, `swarms/utils`)**
    ...
    - [Tools Overview](https://docs.swarms.world/swarms_tools/overview/)
    
    - [BaseTool Reference](https://docs.swarms.world/swarms/tools/base_tool/)
...
3. **Reasoning & Specialized Agents (`swarms/agents`)**
    ...
    - [Reasoning Agents Overview](https://docs.swarms.world/swarms/agents/reasoning_agents_overview/)
    
    - [Self Consistency Agent](https://docs.swarms.world/swarms/agents/consistency_agent/)
    
    - [Agent Judge](https://docs.swarms.world/swarms/agents/agent_judge/)
...
4. **Multi-Agent Structures (`swarms/structs`)**
    ...
    - [Multi-Agent Architectures Overview](https://docs.swarms.world/swarms/concept/swarm_architectures/)
    
    - [MajorityVotingSwarm](https://docs.swarms.world/swarms/structs/majorityvoting/)
    
    - [HierarchicalSwarm](https://docs.swarms.world/swarms/structs/hierarchical_swarm/)
    
    - [Sequential Workflow](https://docs.swarms.world/swarms/structs/sequential_workflow/)
    
    - [Concurrent Workflow](https://docs.swarms.world/swarms/structs/concurrentworkflow/)
...
5. **Supporting Components**
    ...
    integration with external systems (e.g., Redis, DuckDB, Pulsar). See [Communication Structure](https://docs.swarms.world/swarms/structs/conversation/)
...
**Learn more:** See the full [SIP Guidelines and Template](https://docs.swarms.world/protocol/sip/)
...
- Support for YAML-based agent creation and configuration. See [YAML Agent Creation](https://docs.swarms.world/swarms/
...
- [Agents Overview](https://docs.swarms.world/swarms/framework/agents_explained/)
...
- [Tools Reference](https://docs.swarms.world/swarms/tools/tools_examples/)

- [What are tools?](https://docs.swarms.world/swarms/tools/build_tool/)
...
- [Custom Multi Agent Architectures](https://docs.swarms.world/swarms/structs/custom_swarm/)
...
- Memory and caching for agents and tools. See [Integrating RAG with Agents](https://docs.swarms.world/swarms/memory/
diy_memory/)
...
- [Communication Structure](https://docs.swarms.world/swarms/structs/conversation/)
...
- [CLI Documentation](https://docs.swarms.world/swarms/cli/cli_reference/)
...
For more advanced examples, see the [Examples Overview](https://docs.swarms.world/examples/).
...
For more on the philosophy and architecture, see [Development Philosophy & Principles](https://docs.swarms.world/swarms/concept/philosophy/) and [Understanding Swarms Architecture](https://docs.swarms.world/swarms/concept/framework_architecture/).
...
|-------------------------------------- |----------------------------------------------------------------------------------------|--------------------------------------------------|
| Swarms Docs Home                     | [Swarms Docs Home](https://docs.swarms.world/)                               | Main documentation homepage                      |
| Quickstart for Agents                | [Quickstart for Agents](https://docs.swarms.world/swarms/agents/)            | Getting started with Swarms agents               |
| Agent API Reference                  | [Agent API Reference](https://docs.swarms.world/swarms/structs/agent/)       | API reference for Agent class                    |
| Tools Overview                       | [Tools Overview](https://docs.swarms.world/swarms_tools/overview/)           | Overview of available tools                      |
| BaseTool Reference                   | [BaseTool Reference](https://docs.swarms.world/swarms/tools/base_tool/)      | Reference for the BaseTool class                 |
| Reasoning Agents Overview            | [Reasoning Agents Overview](https://docs.swarms.world/swarms/agents/reasoning_agents_overview/) | Overview of reasoning agents                     |
| Multi-Agent Architectures Overview   | [Multi-Agent Architectures Overview](https://docs.swarms.world/swarms/concept/swarm_architectures/) | Multi-agent system architectures                 |
| Examples Overview                    | [Examples Overview](https://docs.swarms.world/examples/)               | Example projects and use cases                   |
| CLI Documentation                    | [CLI Documentation](https://docs.swarms.world/swarms/cli/cli_reference/)              | Command-line interface documentation             |
...
| Development Philosophy & Principles  | [Development Philosophy & Principles](https://docs.swarms.world/swarms/concept/philosophy/) | Framework philosophy and guiding principles      |
| Understanding Swarms Architecture    | [Understanding Swarms Architecture](https://docs.swarms.world/swarms/concept/framework_architecture/) | In-depth look at Swarms architecture             |
| SIP Guidelines and Template          | [SIP Guidelines and Template](https://docs.swarms.world/protocol/sip/)       | Swarms Improvement Proposal process and template |
